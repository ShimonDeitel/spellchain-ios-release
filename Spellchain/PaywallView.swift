...
struct PaywallView: View {
    ...
    private let benefits: [(String, String, String)] = [
        ("infinity", "Unlimited practice", "Fresh random letter sets any time — play as much as you want."),
        ("calendar", "Puzzle archive", "Replay any past daily set, all the way back."),
        ("square.grid.2x2", "Alternate letter packs", "New letter distributions for a different kind of challenge."),
        ("text.magnifyingglass", "Words you missed", "After every round, see every word in the set you didn't find.")
    ]
            ...
            ScrollView {
                VStack(spacing: 22) {
                    VStack(spacing: 8) {
                        ...
                        Text("Spellchain Pro").font(.largeTitle.weight(.heavy))
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text("Spellchain never tracks you. Your results stay on your device.")
